...
2. To Install the Bootstrap Grid Type "npm install bootstrap-grid-only-css --save". then Type <kbd> <link rel="stylesheet" href="dist/css/bootstrap-grid.min.css" /> </kbd>
